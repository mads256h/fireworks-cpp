...
if (UBSAN)
    if (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
        ...
        message(STATUS "Please see if MSVC supports undefined behavior sanitizer: https://learn.microsoft.com/en-us/cpp/sanitizers/asan")
    else ()
        add_compile_options(-fsanitize=undefined)
...
if (TSAN)
    if (CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
        ...
        message(STATUS "Please see if MSVC supports thread sanitizer: https://learn.microsoft.com/en-us/cpp/sanitizers/asan")
    else ()
        add_compile_options(-fsanitize=thread)
